...
const BackgroundBrickStack = ({width, height, color}) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/Svg">
      <Circle cx="19.1501" cy="19" r="19" fill={color}/>
      <Path fill-rule="evenodd" clip-rule="evenodd" d="M13.5563 22.2106H25.0203V28.4048H23.2688C23.2688 28.3991 23.2689 28.3935 23.2689 28.3878C23.2689 26.0477 21.4938 24.1506 19.3042 24.1506C17.1146 24.1506 15.3396 26.0477 15.3396 28.3878C15.3396 28.3935 15.3396 28.3991 15.3396 28.4048H13.5563V22.2106Z" fill="#E9795B"/>
